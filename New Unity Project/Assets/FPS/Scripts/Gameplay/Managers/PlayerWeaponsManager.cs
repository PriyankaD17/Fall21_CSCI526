...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            // weapon switch handling !IsAiming &&
            if (
        ...
        public void ShooyS()
        {
            ...
            {
                Debug.Log(2);
                m_AccumulatedRecoil += Vector3.back * 55F;
