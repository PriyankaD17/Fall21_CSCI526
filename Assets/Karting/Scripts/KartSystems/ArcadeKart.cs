...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        [Header("Haptics")]
        [Tooltip("Minimum impulse magnitude to trigger vibration")]
        public float VibrationImpulseThreshold = 5.0f;
        [Tooltip("Time intervals between two collisions triggering vibration")]
        public float VibrationCooldownInterval = 0.5f;
        ...
        void OnCollisionStay(Collision collision)
        {
            ...
            if (collision.impulse.magnitude > VibrationImpulseThreshold) {
                int vibrationAmplitude = ((int)Mathf.Clamp(3 * (Mathf.Sqrt(collision.impulse.magnitude - VibrationImpulseThreshold)), 1.0f, 255.0f));
                Vibration.Vibrate(10, vibrationAmplitude);
                Debug.Log("collision of magnitude " + collision.impulse.magnitude.ToString() +
                    " => vibration amplitude " + vibrationAmplitude.ToString());
            }
        }
